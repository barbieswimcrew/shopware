...
class Shopware_Controllers_Frontend_Mollie extends AbstractPaymentController
{
     ...
     */
    public function initController(Enlight_Controller_Request_RequestHttp $request, Enlight_Controller_Response_ResponseHttp $response)
    {
        parent::initController($request, $response); // TODO: Change the autogenerated stub
